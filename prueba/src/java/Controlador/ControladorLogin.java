...
public class ControladorLogin extends HttpServlet {
    ...
    public String getServletInfo() {
     ...
     private void verificar(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (usuarios != null && usuarios.getPerfil_idperfil().getDescripcionPerfil().equals("administrador")) {
        ...
        } else if (usuarios != null && usuarios.getPerfil_idperfil().getDescripcionPerfil().equals("empleado")) {
    ...
    private Usuarios obtenerUsuario(HttpServletRequest request) {
        ...
        usuarios.setPassword(request.getParameter("txtpassword"));
        return usuarios;
    }
